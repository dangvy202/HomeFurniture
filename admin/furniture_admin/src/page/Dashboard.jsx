...
import './dashboard/plugins/jquery/jquery.min.js';
import './dashboard/plugins/jquery-ui/jquery-ui.min.js';
import './dashboard/plugins/bootstrap/js/bootstrap.bundle.min.js';
import './dashboard/plugins/chart.js/Chart.min.js';
import './dashboard/plugins/sparklines/sparkline.js';
import './dashboard/plugins/jqvmap/jquery.vmap.min.js';
import './dashboard/plugins/jqvmap/maps/jquery.vmap.usa.js';
import './dashboard/plugins/jquery-knob/jquery.knob.min.js';
import './dashboard/plugins/moment/moment.min.js';
import './dashboard/plugins/daterangepicker/daterangepicker.js';
import './dashboard/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js';
import './dashboard/plugins/summernote/summernote-bs4.min.js';
import './dashboard/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js';
import './dashboard/dist/js/adminlte.js';
import './dashboard/dist/js/demo.js';
import './dashboard/dist/js/pages/dashboard.js';
